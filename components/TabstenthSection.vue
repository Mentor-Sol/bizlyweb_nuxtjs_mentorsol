<template>
  <div v-for="(feed, index) in feedData" :key="index">
    <div class="inner-tabs-wrapper" v-if="feed?.text_type_value">
      ...
      <div class="main-thums-Slider main-thums-Slider-second collection-thums-slider">
        ...
        <div class="d-flex justify-content-between slider-inner-icons">
          ...
          <div>
            <div class="img-box d-flex align-items-center gap-2">
...
<script setup>
import SecondSectionImg from "~/public/assets/images/tenthbgimg.png";
...
import BlackImgVideo from "~/public/assets/images/textblack.png";
...
import VideoAlbum from "~/public/assets/images/textwhite.png";
